...
def run_kora_cool_scraper():
    # المصدر: كورة كول (Kora Cool) عبر RSS لضمان استقرار جلب الأخبار والصور
    rss_url = "https://www.kooora4goal.com/feed/"
            ...
            if i == 0:
                ...
                <div class="sky-hero-main">
                    <a href="{my_link}" target="_blank">
                        <img src="{img}" alt="Kora Cool News">
                        <div class="sky-hero-text">
                            <span class="sky-label-live">كورة كول الآن</span>
                            <h3>{title}</h3>
                        </div>
                    </a>
                </div>'''
                    ...
                    <a href="{my_link}" target="_blank">
                        <div class="sky-card-flex">
                            ...
                            <div class="sky-card-info">
                                <h3>{title}</h3>
                                <span class="sky-meta">أخبار حصرية | كورة كول</span>
                            </div>
                        </div>
                    </a>
                </div>'''
...
<head>
    ...
    <title>ستاديوم 24 | كورة كول</title>
    ...
    <style>
        ...
        .live-tag {{ background: #ed1c24; color: #fff; padding: 4px 18px; font-weight: bold; font-size: 14px; border-radius: 2px; }}
...
<body>
    ...
    <div class="sky-list">
        <h2 style="border-right: 5px solid #ed1c24; padding-right: 15px; font-size: 20px; margin-bottom: 25px;">أحدث أخبار كورة كول</h2>
        {news_html[news_html.find('</div>', news_html.find('sky-hero-main'))+6:]}
    </div>
    ...
    <footer style="background: #111; color: #fff; padding: 50px 20px; text-align: center; border-top: 5px solid #ed1c24;">
        ...
        <p style="font-size: 12px; opacity: 0.6;">بالتعاون مع كورة كول لأحدث المستجدات الرياضية</p>
    </footer>
</body>
</html>'''
